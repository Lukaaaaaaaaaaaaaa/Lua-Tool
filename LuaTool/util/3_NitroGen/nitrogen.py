...
class NitroGen: 
    ...
    def main(self): 
        ...
        clear()
        nitrogentitle()
        print(f"""{y}[{w}#{y}]{w} NAPISI KOLIKO LINKOVA ZELIS DA SE GENERIRAJU!""")
        num = int(input(f"""{y}[{b}#{y}]{w} BROJ: """))
        ...
        for i in range(num): 
            try: 
                ...
                url = f"https://discord.gift/rjVpwMZHADP7bR59EB3nBFGY{code}"
...
{y}[{b}+{y}]{w} Results:
    ...
    def generator(self, amount):
        with open(self.fileName, "w", encoding="utf-8") as file:
            print(f"{y}[{b}#{y}]{w} PRICEKAJ, GENERIRA ZA TEBE!")
            ...
            for i in range(amount):
                ...
                file.write(f"https://discord.gift/rjVpwMZHADP7bR59EB3nBFGY{code}\n")
